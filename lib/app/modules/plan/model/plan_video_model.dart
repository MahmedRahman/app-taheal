...
VideoPlanModel videoPlanModelFromJson(String str) =>
    VideoPlanModel.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        vediosMotorFunction: List<MyVedio>.from(
            json["vedios_motor_function"].map((x) => MyVedio.fromJson(x))),
        myVedio: List<MyVedio>.from(
            json["my_vedio"].map((x) => MyVedio.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "vedios_motor_function":
            List<dynamic>.from(vediosMotorFunction.map((x) => x.toJson())),
...
class MyVedio {
  ...
  factory MyVedio.fromJson(Map<String, dynamic> json) => MyVedio(
        ...
        imagevedio: json["image_vedio"] == null ? '' : json["image_vedio"],
      );
